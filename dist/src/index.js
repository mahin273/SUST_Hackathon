...
const safetyGuardrails_1 = require("./safetyGuardrails");
...
app.post('/analyze-ticket', async (req, res) => {
    try {
        ...
        const requestParseResult = schemas_1.RequestSchema.safeParse(req.body);
        ...
        let llmResult;
        try {
            llmResult = await (0, llmClient_1.analyzeTicketWithLLM)(ticket);
        }
        catch (llmError) {
        ...
        const sanitizedResponse = (0, safetyGuardrails_1.applySafetyGuardrails)(ticket, llmResult);
        // 4. Validate output schema before sending it back
        const responseParseResult = schemas_1.ResponseSchema.safeParse(sanitizedResponse);
