...
const CASES_FILE = path_1.default.join(__dirname, '../SUST_Preli_Sample_Cases.json');
/**
 * Checks if the customer reply violates any safety guidelines.
 */
function verifySafety(reply, nextAction) {
...
async function runTests() {
    ...
    // 2. Load test cases
    if (!fs_1.default.existsSync(CASES_FILE)) {
